...
Std_ReturnType dc_motor_initialization(const dc_motor_t *motor_config)
{
    ...
    else
    {
        ...
        if ( (gpio_pin_direction_init(&(motor_config ->motor[0x00U]))) && (gpio_pin_direction_init(&(motor_config ->motor[0x01U]))) )
        {
...
Std_ReturnType dc_motor_move_left(const dc_motor_t *motor_config)
{
    ...
    {
        if ( (gpio_pin_write_logic(&(motor_config ->motor[0x00U]), GPIO_HIGH)) && (gpio_pin_write_logic(&(motor_config ->motor[0x01U]), GPIO_LOW)) )
        {
...
# 77 "ECU_Layer/DC_Motor/ecu_dc_motor.c"
Std_ReturnType dc_motor_move_right(const dc_motor_t *motor_config)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    ...
    {
        if ( (gpio_pin_write_logic(&(motor_config ->motor[0x01U]), GPIO_HIGH)) && (gpio_pin_write_logic(&(motor_config ->motor[0x00U]), GPIO_LOW)) )
        {
...
# 105 "ECU_Layer/DC_Motor/ecu_dc_motor.c"
Std_ReturnType dc_motor_move_stop(const dc_motor_t *motor_config)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    ...
    {
        if ( (gpio_pin_write_logic(&(motor_config ->motor[0x00U]), GPIO_LOW)) && (gpio_pin_write_logic(&(motor_config ->motor[0x01U]), GPIO_LOW)) )
        {
